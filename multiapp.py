...
class MultiApp:
    ...
    def run(self):
        ...
        title = st.sidebar.radio("Ir a ", titles, index=default_radio, key="radio")
        ...
        st.sidebar.info(
           """El presente trabajo es parte del Curso de Programacion en Sistemas de Información Geografica 
           Este contendra un aplicaciones en referencias a desarrollo de los cursos con la Utilizacion de las librerias de 
           Google Earth Engine y Otros"""
        )
